...
class ExecutiveSovereigntyCycleBlocked(RuntimeError): pass

STAGES=(
('EXECUTIVE_CONSTITUTIONAL_OBSERVATION','executive_constitutional_cycles','executive_constitutional_cycle_id','executive_constitutional_cycle_result','EXECUTIVE_CONSTITUTIONAL_CYCLE_READY','executive_constitutional_observations','executive_constitutional_observation_id','executive_constitutional_cycle_id','executive_constitutional_observation_result','EXECUTIVE_CONSTITUTIONAL_OBSERVATION_READY'),
('EXECUTIVE_SOVEREIGNTY_RECONSTRUCTION','executive_constitutional_observations','executive_constitutional_observation_id','executive_constitutional_observation_result','EXECUTIVE_CONSTITUTIONAL_OBSERVATION_READY','executive_sovereignty_reconstructions','executive_sovereignty_id','executive_constitutional_observation_id','executive_sovereignty_result','EXECUTIVE_SOVEREIGNTY_READY'),
('EXECUTIVE_JURISDICTION_AUTHORITY','executive_sovereignty_reconstructions','executive_sovereignty_id','executive_sovereignty_result','EXECUTIVE_SOVEREIGNTY_READY','executive_jurisdiction_authorities','executive_jurisdiction_id','executive_sovereignty_id','executive_jurisdiction_result','EXECUTIVE_JURISDICTION_READY'),
('EXECUTIVE_SUPREMACY_AUTHORITY','executive_jurisdiction_authorities','executive_jurisdiction_id','executive_jurisdiction_result','EXECUTIVE_JURISDICTION_READY','executive_supremacy_authorities','executive_supremacy_id','executive_jurisdiction_id','executive_supremacy_result','EXECUTIVE_SUPREMACY_READY'),
('EXECUTIVE_SOVEREIGNTY_CYCLE_AUTHORITY','executive_supremacy_authorities','executive_supremacy_id','executive_supremacy_result','EXECUTIVE_SUPREMACY_READY','executive_sovereignty_cycles','executive_sovereignty_cycle_id','executive_supremacy_id','executive_sovereignty_cycle_result','EXECUTIVE_SOVEREIGNTY_CYCLE_READY'))

class ExecutiveSovereigntyCycleService(AuthoritativeService):
 service_name='executive_sovereignty_cycle_service'
 ...
 def reconstruct(self,*,stage,authority_id,parent_id,request_id,intent):
  ...
  if not s or not all(str(v).strip() for v in(authority_id,parent_id,request_id)) or str(intent).upper()!=f'RECONSTRUCT_{stage}': raise ExecutiveSovereigntyCycleBlocked('Explicit complete executive sovereignty authority required')
 ...
 def get(self,stage,authority_id):
  ...
  with self.database.read_connection() as c:
   ...
   if not row or n!=1: raise ExecutiveSovereigntyCycleBlocked(f'{stage} reconstruction failed')
   return dict(row)
 @staticmethod

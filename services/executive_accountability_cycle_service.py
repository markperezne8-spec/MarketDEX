...
class ExecutiveAccountabilityCycleBlocked(RuntimeError): pass

STAGES=(
('EXECUTIVE_STEWARDSHIP_OBSERVATION','executive_stewardship_cycles','executive_stewardship_cycle_id','executive_stewardship_cycle_result','EXECUTIVE_STEWARDSHIP_CYCLE_READY','executive_stewardship_observations','executive_stewardship_observation_id','executive_stewardship_cycle_id','executive_stewardship_observation_result','EXECUTIVE_STEWARDSHIP_OBSERVATION_READY'),
('EXECUTIVE_ACCOUNTABILITY_RECONSTRUCTION','executive_stewardship_observations','executive_stewardship_observation_id','executive_stewardship_observation_result','EXECUTIVE_STEWARDSHIP_OBSERVATION_READY','executive_accountability_reconstructions','executive_accountability_id','executive_stewardship_observation_id','executive_accountability_result','EXECUTIVE_ACCOUNTABILITY_READY'),
('EXECUTIVE_RESPONSIBILITY_AUTHORITY','executive_accountability_reconstructions','executive_accountability_id','executive_accountability_result','EXECUTIVE_ACCOUNTABILITY_READY','executive_responsibility_authorities','executive_responsibility_id','executive_accountability_id','executive_responsibility_result','EXECUTIVE_RESPONSIBILITY_READY'),
('EXECUTIVE_ANSWERABILITY_AUTHORITY','executive_responsibility_authorities','executive_responsibility_id','executive_responsibility_result','EXECUTIVE_RESPONSIBILITY_READY','executive_answerability_authorities','executive_answerability_id','executive_responsibility_id','executive_answerability_result','EXECUTIVE_ANSWERABILITY_READY'),
('EXECUTIVE_ACCOUNTABILITY_CYCLE_AUTHORITY','executive_answerability_authorities','executive_answerability_id','executive_answerability_result','EXECUTIVE_ANSWERABILITY_READY','executive_accountability_cycles','executive_accountability_cycle_id','executive_answerability_id','executive_accountability_cycle_result','EXECUTIVE_ACCOUNTABILITY_CYCLE_READY'))

class ExecutiveAccountabilityCycleService(AuthoritativeService):
 service_name='executive_accountability_cycle_service'
 ...
 def reconstruct(self,*,stage,authority_id,parent_id,request_id,intent):
  ...
  if not s or not all(str(v).strip() for v in(authority_id,parent_id,request_id)) or str(intent).upper()!=f'RECONSTRUCT_{stage}': raise ExecutiveAccountabilityCycleBlocked('Explicit complete executive accountability authority required')
 ...
 def get(self,stage,authority_id):
  ...
  with self.database.read_connection() as c:
   ...
   if not row or n!=1: raise ExecutiveAccountabilityCycleBlocked(f'{stage} reconstruction failed')
   return dict(row)
 @staticmethod

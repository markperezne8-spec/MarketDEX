...
class ExecutiveStewardshipCycleBlocked(RuntimeError): pass

STAGES=(
('EXECUTIVE_LEGITIMACY_OBSERVATION','executive_legitimacy_cycles','executive_legitimacy_cycle_id','executive_legitimacy_cycle_result','EXECUTIVE_LEGITIMACY_CYCLE_READY','executive_legitimacy_observations','executive_legitimacy_observation_id','executive_legitimacy_cycle_id','executive_legitimacy_observation_result','EXECUTIVE_LEGITIMACY_OBSERVATION_READY'),
('EXECUTIVE_STEWARDSHIP_RECONSTRUCTION','executive_legitimacy_observations','executive_legitimacy_observation_id','executive_legitimacy_observation_result','EXECUTIVE_LEGITIMACY_OBSERVATION_READY','executive_stewardship_reconstructions','executive_stewardship_id','executive_legitimacy_observation_id','executive_stewardship_result','EXECUTIVE_STEWARDSHIP_READY'),
('EXECUTIVE_CUSTODY_AUTHORITY','executive_stewardship_reconstructions','executive_stewardship_id','executive_stewardship_result','EXECUTIVE_STEWARDSHIP_READY','executive_custody_authorities','executive_custody_id','executive_stewardship_id','executive_custody_result','EXECUTIVE_CUSTODY_READY'),
('EXECUTIVE_DUTY_AUTHORITY','executive_custody_authorities','executive_custody_id','executive_custody_result','EXECUTIVE_CUSTODY_READY','executive_duty_authorities','executive_duty_id','executive_custody_id','executive_duty_result','EXECUTIVE_DUTY_READY'),
('EXECUTIVE_STEWARDSHIP_CYCLE_AUTHORITY','executive_duty_authorities','executive_duty_id','executive_duty_result','EXECUTIVE_DUTY_READY','executive_stewardship_cycles','executive_stewardship_cycle_id','executive_duty_id','executive_stewardship_cycle_result','EXECUTIVE_STEWARDSHIP_CYCLE_READY'))

class ExecutiveStewardshipCycleService(AuthoritativeService):
 service_name='executive_stewardship_cycle_service'
 ...
 def reconstruct(self,*,stage,authority_id,parent_id,request_id,intent):
  ...
  if not s or not all(str(v).strip() for v in(authority_id,parent_id,request_id)) or str(intent).upper()!=f'RECONSTRUCT_{stage}': raise ExecutiveStewardshipCycleBlocked('Explicit complete executive stewardship authority required')
 ...
 def get(self,stage,authority_id):
  ...
  with self.database.read_connection() as c:
   ...
   if not row or n!=1: raise ExecutiveStewardshipCycleBlocked(f'{stage} reconstruction failed')
   return dict(row)
 @staticmethod

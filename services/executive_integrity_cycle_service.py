...
class ExecutiveIntegrityCycleBlocked(RuntimeError): pass

STAGES=(
 ('EXECUTIVE_TRANSPARENCY_OBSERVATION','executive_transparency_cycles','executive_transparency_cycle_id','executive_transparency_cycle_result','EXECUTIVE_TRANSPARENCY_CYCLE_READY','executive_transparency_observations','executive_transparency_observation_id','executive_transparency_cycle_id','executive_transparency_observation_result','EXECUTIVE_TRANSPARENCY_OBSERVATION_READY'),
 ('EXECUTIVE_INTEGRITY_RECONSTRUCTION','executive_transparency_observations','executive_transparency_observation_id','executive_transparency_observation_result','EXECUTIVE_TRANSPARENCY_OBSERVATION_READY','executive_integrity_reconstructions','executive_integrity_id','executive_transparency_observation_id','executive_integrity_result','EXECUTIVE_INTEGRITY_READY'),
 ('EXECUTIVE_ETHICAL_AUTHORITY','executive_integrity_reconstructions','executive_integrity_id','executive_integrity_result','EXECUTIVE_INTEGRITY_READY','executive_ethical_authorities','executive_ethical_id','executive_integrity_id','executive_ethical_result','EXECUTIVE_ETHICAL_READY'),
 ('EXECUTIVE_FIDELITY_AUTHORITY','executive_ethical_authorities','executive_ethical_id','executive_ethical_result','EXECUTIVE_ETHICAL_READY','executive_fidelity_authorities','executive_fidelity_id','executive_ethical_id','executive_fidelity_result','EXECUTIVE_FIDELITY_READY'),
 ('EXECUTIVE_INTEGRITY_CYCLE_AUTHORITY','executive_fidelity_authorities','executive_fidelity_id','executive_fidelity_result','EXECUTIVE_FIDELITY_READY','executive_integrity_cycles','executive_integrity_cycle_id','executive_fidelity_id','executive_integrity_cycle_result','EXECUTIVE_INTEGRITY_CYCLE_READY'))

class ExecutiveIntegrityCycleService(AuthoritativeService):
 service_name='executive_integrity_cycle_service'
 ...
 def reconstruct(self,*,stage,authority_id,parent_id,request_id,intent):
  ...
  if not s or not all(str(v).strip() for v in(authority_id,parent_id,request_id)) or str(intent).upper()!=f'RECONSTRUCT_{stage}': raise ExecutiveIntegrityCycleBlocked('Explicit complete executive integrity authority required')
 ...
 def get(self,stage,authority_id):
  ...
  with self.database.read_connection() as c:
   ...
   if not row or n!=1: raise ExecutiveIntegrityCycleBlocked(f'{stage} reconstruction failed')
   return dict(row)
 @staticmethod

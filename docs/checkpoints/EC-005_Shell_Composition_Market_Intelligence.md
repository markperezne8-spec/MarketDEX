# EC-005 — Shell, Composition, and Market Intelligence Foundation
...
### PR #166 — Market intelligence foundation — draft
...
| Architecture | PASS | Stable workspace, feature, marketplace, mode, observation, and chart contracts |
...
4. Begin Collection Overview Workspace and Business/Collector Mode Toggle.

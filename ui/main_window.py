...
from ui.inventory_workspace_control_layout import InventoryWorkspaceControlLayout
from ui.inventory_listing_readiness_feature import install_inventory_listing_readiness_feature
from ui.inventory_analytics_feature import install_inventory_analytics_feature
...
class MainWindow(QMainWindow):
    ...
    def add_asset(self):
        ...
        try:
            ...
            tcg_values={'product_name':dialog.product_name.text() or dialog.name.text(),'set_name':dialog.set_name.text(),'item_condition':dialog.item_condition.currentText(),'market_price_minor':round(dialog.market_price.value()*100)}
